...
public class BlockBoard extends Canvas {
  ...
  private void initSize() {
    ...
    TILE_SIZE = (int) Math.floor((innerWidth - (NumberBlock.ROWS - 1) * INTERNAL) / NumberBlock.ROWS);
    innerHeight = TILE_SIZE * NumberBlock.COLS + INTERNAL * (NumberBlock.COLS - 1);
  ...
  private void drawBoard() {
    ...
    for (int col = 0; col < NumberBlock.ROWS - 1; col++) {
      int gapX = Mth.r(BORDER + col * (TILE_SIZE + INTERNAL) + TILE_SIZE);
